...
function neuronLabel(data,n){
 ...
 return `#${n} · ${n<inputs?(M.input_labels[n]||`Input ${n}`):n>=data.neurons.length-outputs?`Action ${['move','turn left','turn right','forage','call'][n-(data.neurons.length-outputs)]||n}`:'Recurrent neuron'}`;
}
